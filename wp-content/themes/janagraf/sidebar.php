<span id="info_line"><?php bloginfo( 'name' ); ?> <span id="m">postatjanagrafcom</span> (+49)0221.54813483</span> <span id="info_link"><a href="#" onclick="return slideHideInfo();">Info</a></span>
<div id="info">
	<h1>Jana Graf</h1>
	<h3>born 1986</h3>
<?php
